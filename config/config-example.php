...
define('WEEEHIRE_LDAP_SHOW_USERS_FILTER', '(&(objectclass=weeeopenperson)(!(nsaccountlock=true))(|(memberOf=cn=Admins,ou=Groups,dc=example,dc=com)(memberOf=cn=SomeGroup,ou=Groups,dc=example,dc=com)))');
